...
Add this file to your existing backend's app/routers/ directory.

    GET /api/v1/landcover?lat=9.9252&lon=78.1198

Wire it into main.py the same way land.py/analysis.py are already
wired in (see integration notes in the chat response):
